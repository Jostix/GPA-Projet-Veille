 ...
 */
public class ServletFilVeilleProtection extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            //Ajout de l'entête
            HtmlHttpUtils.doHeader("<span class='glyphicon glyphicon-th-list'></span> Fil d'actualité - Veille protection", out, request, response);

            // ---------------------------  TOP 5
            // Récupère la liste du top 5 des messages
            List<Message> listeMessageTop5 =  MessageService.findAllMessage(true,false,true);
            ...
            List<Message> listeMessage = MessageService.findAllMessage(false,false,true);
            ...
            Logger.getLogger(ServletFilVeilleProtection.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            out.close();
        }
    }
